...
bun create svelte@latest ragchat --template skeleton
cd ragchat
bun install

# Add storage and search
bun add dexie @orama/orama
...
**If the project stays v1-only (no RAG phase ever):**
...
**If the user wants React despite the recommendation:**
...
**If multi-tab sync becomes a requirement:**
...
**If the dataset exceeds 50K messages:**
...
*Stack research for: WhatsApp Chat Parser + RAG Web App (RagChat)*
*Researched: 2026-07-28*
