...
See /Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using /Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/discovery.md
...
Use /Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/discovery.md.
