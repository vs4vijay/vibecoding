...
```
Agent(
  prompt="Read /Volumes/Main/GitHub/vibecoding/skills/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/VALIDATION.md`
