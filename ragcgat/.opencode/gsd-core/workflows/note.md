...
- **Global scope**: `/Volumes/Main/GitHub/vibecoding/skills/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Volumes/Main/GitHub/vibecoding/skills/.opencode/notes/`)
...
2. Glob `/Volumes/Main/GitHub/vibecoding/skills/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Volumes/Main/GitHub/vibecoding/skills/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Volumes/Main/GitHub/vibecoding/skills/.opencode/notes/` — works in any directory
