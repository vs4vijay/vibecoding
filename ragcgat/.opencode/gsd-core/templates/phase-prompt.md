...
<!-- For checkpoint task examples and patterns, see @/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/references/checkpoints.md -->
...
See `/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/workflows/verify-phase.md` for verification logic.
