...
<reference>
@/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/references/user-profiling.md` to load:
