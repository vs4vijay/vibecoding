...
Reference full template: `/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/state.md`.
