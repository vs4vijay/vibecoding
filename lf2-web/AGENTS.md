...
- **Persistence keys are exactly `lf2.bindings.v1`** (input remapping) **and
  `lf2.muted`** (audio). No other keys, no prefixes drift.
...
`https://vs4vijay.github.io/vibecoding/lf2-web/`. `vite.config.ts` sets
