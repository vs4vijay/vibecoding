...
export class PhysicsWorld {
    ...
    addBox(center, halfExtents) {
        const body = this.raw.createRigidBody(RAPIER.RigidBodyDesc.fixed().setTranslation(center.x, center.y, center.z));
        const box = RAPIER.ColliderDesc.cuboid(halfExtents.x, halfExtents.y, halfExtents.z).setFriction(TERRAIN_FRICTION);
