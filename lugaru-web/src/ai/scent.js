 ...
 * threshold.
 */
import { ARENA_SIZE_M, SCENT_DIFFUSION_D, SCENT_EMIT_RATE_BASE, SCENT_EMIT_RATE_BLOODIED, SCENT_GRID_CELLS, } from '../data/tuning';
/** Emission rate (units/s) for a clean vs bloodied fighter (via caller). */
export function emissionRateFor(bloodied) {
