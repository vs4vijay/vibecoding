...
import { cleanBlade, heldWeapon, onReversalVsArmed, throwKnife, thrownKnifeHit, tryClash, } from '../../src/combat/weaponsLogic';
import { WEAPONS } from '../../src/data/weapons';
import { MOVES } from '../../src/data/moves';
import { CLASH_KNOCK_SPEED_MPS, THROWN_KNIFE_SPEED_MPS, } from '../../src/data/tuning';
 ...
 */
function makeArmedPair(aWeapon, bWeapon, dist = 0.6, over = {}) {
    const a = makeFighter({
        weapon: aWeapon,
...
describe('resolver armed attack', () => {
    ...
    it('an armed fighter swings their weapon at an in-reach target', () => {
        ...
        for (const weapon of ['sword', 'knife', 'staff']) {
