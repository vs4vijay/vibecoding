...
- Usage: Reference from command with `@/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Volumes/Main/GitHub/vibecoding/skills/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Volumes/Main/GitHub/vibecoding/skills/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
