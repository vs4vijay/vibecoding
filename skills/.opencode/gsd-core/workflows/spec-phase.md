...
ones). Reference: @/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Volumes/Main/GitHub/vibecoding/skills/.opencode.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/bin/lib/edge-probe.cjs" \
  "/Volumes/Main/GitHub/vibecoding/skills/.opencode/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/spec.md.
