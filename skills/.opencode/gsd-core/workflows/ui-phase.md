...
```markdown
Read /Volumes/Main/GitHub/vibecoding/skills/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /Volumes/Main/GitHub/vibecoding/skills/.opencode/agents/gsd-ui-checker.md for instructions.
...
@/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /Volumes/Main/GitHub/vibecoding/skills/.opencode.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/Volumes/Main/GitHub/vibecoding/skills/.opencode/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
