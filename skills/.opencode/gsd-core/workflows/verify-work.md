...
<template>
@/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/workflows/transition.md`.
...
- Follow @/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/workflows/diagnose-issues.md
