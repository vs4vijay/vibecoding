...
INSTALL_JS_GLOBAL="/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
