...
```markdown
Read /Volumes/Main/GitHub/vibecoding/skills/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Volumes/Main/GitHub/vibecoding/skills/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Volumes/Main/GitHub/vibecoding/skills/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Volumes/Main/GitHub/vibecoding/skills/.opencode/agents/gsd-eval-planner.md for instructions.
