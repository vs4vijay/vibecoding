...
**Verification depth scales with `asvs_level`** (see @/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
