...
<required_reading>
Read `/Volumes/Main/GitHub/vibecoding/skills/.opencode/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
